<?php 
function radon_page_menu_args( $args ) {
	if ( ! isset( $args['show_home'] ) )
		$args['show_home'] = true;
	return $args;
}
add_filter( 'wp_page_menu_args', 'radon_page_menu_args' );

 
function radon_fallback_page_menu( $args = array() ) {
	...
	$list_args['title_li'] = '';
	$list_args['walker'] = new radon_walker_page_menu;
...
class radon_walker_page_menu extends Walker_Page{

...
function avadanta_enqueue_script()
	...
	function teczilla_admin_enqueue_scripts(){
    wp_enqueue_script( 'teczilla-admin-script', get_template_directory_uri() . '/assets/js/teczilla-admin-script.js', array( 'jquery' ), '', true );
    wp_localize_script( 'teczilla-admin-script', 'teczilla_ajax_object',
        array( 'ajax_url' => esc_url(admin_url( 'admin-ajax.php' ) ))
    );
}
add_action( 'admin_enqueue_scripts', 'teczilla_admin_enqueue_scripts' );